---
title: ESS 330 Results/Discussion Draft
authors:
  - name: Maya McCain
...
**Figure 1. Streamflow in the Cache la Poudre River and Joe Wright SNOTEL Station SWE over a 20 year period.** 
```{r}
...
```{r}
knitr::include_graphics("swe_flow_timeseries_ess_330.png")
```


**Figure 2. Average Monthly Streamflow and SWE.**
```{r}
knitr::include_graphics("monthly_swe_flow.png")
```
...
**Figure 4. pre and post fire t-test**
```{r}
...
plot(swe, type = "l", col = "blue", xlab = "Time", ylab = "SWE", main = "SWE and Discharge over Time")
lines(discharge, col = "red")
legend("topright", legend = c("SWE", "Discharge"), col = c("blue", "red"), lty = 1)
